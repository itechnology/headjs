...
;(function(win, undefined) {
    ...
    // usefull for enabling/disabling feature (we can consider a desktop navigator to have more cpu/gpu power)        
    ...
    function screenSize() {
        ...
        api.feature("portrait" , ih > iw, true);
        api.feature("landscape", iw > ih, true);
